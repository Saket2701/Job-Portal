    ...
    <div class="row">
      <div class="col-md-7">
        ...
        <div class="custom-breadcrumbs">
          ...
          <a href="#">Applications</a> <span class="mx-2 slash">/</span>
          <span class="text-white"><strong>Job Applications</strong></span>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    ...
    <div class="row mb-5 justify-content-center">
      <div class="col-md-7 text-center">
        <h2 class="section-title mb-2">Job Applications</h2>
      </div>
    </div>
    ...
    @else
      <div class="container">
        <div class="alert alert-info text-center">
          <p>No job applications found. Check back later or explore other opportunities.</p>
        </div>
      </div>
    @endif
    </ul>
